 ...
 *  */
public class PntGenerica extends Utils implements Serializable {
/**
	 * 
	 */
...
private int rows;
    ...
    /**
       ...
       public void  selectPntGenericaMDB(String strCadena, String strCadena1,  String pool) throws  NamingException {
           //Pool de conecciones JNDI
           Context initContext = new InitialContext();
           DataSource ds = (DataSource) initContext.lookup(pool);
           try {
